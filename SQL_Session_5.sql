...
TRUNCATE TABLE personel;  --SQLite bu komutu desteklemiyor
...
INSERT INTO vacation_plan VALUES (42, "TURKEY", "HOTEL MEVLANA", 1, 7, 3000);
...
FOREIGN KEY - Başka bir tablodaki Primary Key'i referans göstermek için kullanılır. 
 ...
 --Unique const violation (PK veya UNIQUE CONSTRAINT plan değerlere aynı değer verilemez)
 
 INSERT INTO workers VALUES (1, "12345678910", "CAN ", 10000);
 
 
 INSERT INTO workers VALUES (3, "56667894566", "NULL", 9000);
  
 INSERT INTO workers (id, id_number, salary) VALUES (4, "56644444566", 7000);
...
Bu tablo, employees tablosu ile ilişkili olmalıdır */ 
 ...
 CREATE TABLE vacation_plan2 (
  ...
  FOREIGN KEY (employee_id) REFERENCES employees(EmployeeIdd)
  );
 ...
 /* Employees tablosunda bulunmayan bir kişi için (EmployeeId=9) olan kişi için bir tatil planı giriniz.*/
  ...
  INSERT INTO vacation_plan2 VALUES (34, "TURKEY", "HAPPY NATION", 9, 5, 5000);
...
/* vacation_plan2 tablosunun adını people olarak değiştiriniz */
